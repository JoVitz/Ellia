...
public class Gizmo : MonoBehaviour {
    ...
    public float gridScale_x = 1f;
    public float gridScale_y = 1f;
    ...
    void OnDrawGizmos()
    {
        ...
        for (int x = minX; x < maxX + 1; x++)
        {
            ...
            Vector3 pos1 = new Vector3(x * gridScale_x, minY * gridScale_y, 0);
            Vector3 pos2 = new Vector3(x * gridScale_x, maxY * gridScale_y, 0);
        ...
        for (int y = minY; y < maxY + 1; y++)
        {
            ...
            Vector3 pos1 = new Vector3(minX * gridScale_x, y * gridScale_y, 0);
            Vector3 pos2 = new Vector3(maxX * gridScale_x, y * gridScale_y, 0);
